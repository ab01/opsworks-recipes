bash 'install_flannel' do
  ...
  if [ ! -f /usr/local/bin/flanneld ]; then
    yum install wget -y
    wget --max-redirect 255 https://github.com/coreos/flannel/releases/download/v0.10.0/flannel-0.10.0-linux-amd64.tar.gz
    tar zxvf flannel-0.10.0-linux-amd64.tar.gz
    cd flannel-0.10.0
